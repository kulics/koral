...
- `--memory-limit <MB>`: per-case RSS ceiling, default `1024`; once any case exceeds the active limit, the runner kills that process tree and aborts the remaining suite
